                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" class="form-control" placeholder="Tên bệnh nhân" @if(isset($patient)) value="{{$patient->full_name}}" @else value="{{old('full_name')}}"  @endif>
                            @error('full_name')
                        ...
                        <div class="form-group">
                            ...
                            <input name="dob" type="date" class="form-control" placeholder="Ngày sinh" @if(isset($patient)) value="{{$patient->dob}}" @else value="{{old('dob')}}" @endif>
                            @error('dob')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="guardian_name" type="text" class="form-control" placeholder="Tên người giám hộ" @if(isset($patient)) value="{{$patient->guardian_name}}" @else value="{{old('guardian_name')}}" @endif>
                            @error('guardian_name')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input name="phone_number" type="number" class="form-control" placeholder="Số điện thoại"  @if(isset($patient)) value="{{$patient->phone_number}}" @else value="{{old('phone_number')}}" @endif >
                            @error('phone_number')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ:</label>
                            <input name="address" type="text" class="form-control" placeholder="Địa chỉ" @if(isset($patient)) value="{{$patient->address}}" @else value="{{old('address')}}" @endif>
                            @error('address')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="prognosis" class="form-control" rows="3" placeholder="Nhập chuẩn đoán" value="{{old('prognosis')}}"></textarea>
                            @error('prognosis')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="exam_price" class="form-control" value="{{old('exam_price')}}" placeholder="Nhập tiền khám">
                            @error('exam_price')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="exam_date" value="{{old('exam_date')}}" class="form-control" placeholder="Nhập ngày khám">
                            @error('exam_date')
                            <div style="color: red">*{{ $message }}</div>
                            @enderror
                        </div>
